...
c     correspondentes
      ...
      raios(18) = 30.06d0
      raios(19) = 39.53d0
      velocidades(11) = 8.1205d0*pi*raios(11)
      velocidades(12) = 3.27357d0*pi*raios(12)
      velocidades(13) = 1.99982d0*pi*raios(13)
      velocidades(14) = 1.06489d0*pi*raios(14)
      velocidades(15) = 0.168565d0*pi*raios(15)
      velocidades(16) = 0.07115d0*pi*raios(16)
      velocidades(17) = 0.05d0*pi*raios(17)
      velocidades(18) = 0.06d0*pi*raios(18)
      velocidades(19) = 0.06d0*pi*raios(19)
...
c                 incrementando o controlador em caso verdadeiro
                  if((xproximo*xantigo).lt.0.0d0)then
                        icontrolador = icontrolador + 1
c                        write(*,*)"CRUZOU!!!",xatual,xproximo,'tempo:',tempo
                  end if
